...
jQuery(document).ready(function($) {
    ...
    new ical_parser("calendar.php", function(cal) {
      ...
      for (var i in events) {
        ...
        if (e.RRULE) {
          ...
          var dates = rule.between(new Date(), new Date(2016, 11, 31), true, function(date, i) {
            return i < 10
          });
          for (date in dates) {
  ...
  (function updateCalendar() {
    ...
    var shortList = eventList.slice(0, 10)
